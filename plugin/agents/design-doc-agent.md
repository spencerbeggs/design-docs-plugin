...
**plan-explore** - Explore plan ecosystem, status, and relationships

- Navigate plans with filtering and health analysis
- Discover relationships between plans and design docs
- Identify stale, blocked, or at-risk plans
- Generate actionable recommendations

**plan-complete** - Complete a plan by persisting knowledge to design docs

- Update linked design documentation with implementation results
- Record completion metadata and outcomes
- Remove the transitory plan file after knowledge transfer
- Validate design docs are updated before removal
